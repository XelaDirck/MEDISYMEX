...
<nav class="sidebar-nav">
  ...
  <a href="dashboard_medico_perfil.php" class="btn-acceso">
    ...
    <div class="container">
      ...
      <div class="card shadow-sm mx-auto mb-4" style="max-width: 360px;">
        ...
        <div class="card-body text-center">
          <h5 class="card-title fw-bold mb-1" id="userName">Root Médico</h5>
          <p class="text-muted mb-2" id="userRole">Médico</p>

          <div class="mb-2 text-start">
            <strong>Email:</strong>
            <p class="mb-1" id="userEmail">root@medico.com</p>
          </div>
