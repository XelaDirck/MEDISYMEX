...
<head>
  ...
  <title>Agenda de Citas - MEDISYMEX</title>
...
<main class="flex-grow-1 hero d-flex">
  ...
  <aside class="sidebar-med sidebar-desktop">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="dashboard_medico_agenda.php" class="btn-acceso">
  ...
  <section class="flex-grow-1 py-4">
    <div class="container">
      ...
      <!-- Fila de cards (Filtro de Citas + Agenda del Médico + Nueva Cita Rápida) -->
      <div class="row g-3 mb-4">
        ...
        <div class="col-12 col-lg-8">
          <div class="card shadow-sm h-100">
            ...
            <div class="card-body">
              <!-- Filtros -->
              <form method="GET" action="dashboard_medico_agenda.php" class="row g-3 mb-3 small">
        ...
        <!-- Card de Nueva Cita Rápida y Reagendar Cita (30%) -->
          ...
          <div class="card shadow-sm h-100">
            ...
            <div class="card-body">
              <form method="POST" action="gestionar_cita.php">
                ...
                <!-- Selección de acción -->
                <div class="mb-3">
                  <label class="form-label small">Seleccione una acción</label>
                  <div class="btn-group d-flex">
                    <button type="submit" class="btn btn-outline-primary btn-sm" name="accion" value="agendar">Agendar</button>
                    <button type="submit" class="btn btn-outline-warning btn-sm" name="accion" value="reagendar">Reagendar</button>
                    <button type="submit" class="btn btn-outline-danger btn-sm" name="accion" value="eliminar">Eliminar</button>
                  </div>
                </div>
