...
<nav class="sidebar-nav">
  ...
  <a href="dashboard_recepcionista.php" class="btn-acceso">
...
<div class="text-center mt-4">
  ...
  <!-- Contenido -->
<!-- Contenido -->
<section class="flex-grow-1 d-flex align-items-center justify-content-center min-vh-100">
  <div class="container">
          ...
          <div class="card-body">
            ...
            <form method="GET" action="dashboard_admin_pacientes.php" class="row g-3 mb-3 small">
              ...
              <div class="col-12 d-flex gap-2">
                <button type="submit" class="btn btn-acceso btn-sm">
                  Aplicar
                </button>
...
<div class="col-12 col-lg-4">
  <div class="card shadow-sm h-100" style="padding:0 !important;">
    
    <div class="card-section-header py-2">
    ...
    <div class="card-body py-2">
      ...
      <form id="formRecepAltaPaciente">
        ...
        <div class="mb-1">
          <label class="form-label small mb-0">Nombre completo</label>
          <input type="text" id="altaPacNombre" class="form-control form-control-sm" required>
        </div>

        <div class="mb-1">
          <label class="form-label small mb-0">CURP / ID</label>
        ...
        <div class="mb-1">
          <label class="form-label small mb-0">Estado civil</label>
        ...
        <div class="mb-1">
          <label class="form-label small mb-0">Domicilio</label>
          <textarea id="altaPacDomicilio" class="form-control form-control-sm" rows="1" style="resize:none;" placeholder="Calle, número, colonia, ciudad"></textarea>
        </div>

        <div class="mb-1">
          <label class="form-label small mb-0">Médico responsable</label>
        ...
        <button type="submit" class="btn btn-acceso w-100 btn-sm mt-1">
          Registrar paciente
        </button>
