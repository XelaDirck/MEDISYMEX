...
<nav class="sidebar-nav">
  <a href="dashboard_paciente.php" class="btn-acceso">
  ...
  <a href="dashboard_paciente_tratamietno.php" class="btn-blanco">
    ...
    <div class="card shadow-sm h-100">
      ...
      <div class="row g-3">
        <div class="col-12 col-lg-7">
          <div class="card shadow-sm h-100">
            <div class="card-section card-section-header d-flex justify-content-between">
              <strong>Últimas actividades</strong>
              <span class="small">Cambios recientes en el sistema</span>
            </div>
            <div class="card-body">
              <ul id="adminListaActividades" class="list-group list-group-flush small">
                <li class="list-group-item">No hay actividades registradas aún.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-5">
          <div class="card shadow-sm h-100">
            <div class="card-section card-section-header d-flex justify-content-between">
              ...
              <span class="small">Configuración / agenda / usuarios</span>
            </div>
            <div class="card-body">
              <ul id="adminListaAlertas" class="list-group list-group-flush small">
                <li class="list-group-item">Sin alertas críticas.</li>
              </ul>
            </div>
          </div>
        </div>
